<script lang="ts">
	...
	import AddNewEstimateButton from '$lib/JiraTickets/ui/AddNewEstimateButton.svelte';
	import ViewDetailsButton from '$lib/JiraTickets/ui/ViewDetailsButton.svelte';
	import SearchInput from '$lib/components/SearchInput.svelte';
	import type { JIRATicket } from '$lib/JiraTickets/types';
	...
	function setListFilter(query: string | undefined) {
		...
		return trackingItemList.filter((el: JIRATicket) => {
			if (
