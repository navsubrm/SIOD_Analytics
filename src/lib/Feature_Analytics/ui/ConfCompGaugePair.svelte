<script lang="ts">
	...
	import { getAverageEstimates } from '$lib/ChartsAndGraphs/utils/getAverageOfEstimatesByItem';
	import { getPriorAverageEstimates } from '$lib/ChartsAndGraphs/utils/getPriorAverageOfEstimatesByItem';
